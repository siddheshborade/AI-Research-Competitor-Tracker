...
export function TopBar() {
  ...
  return (
    <>
      <header className="h-16 bg-[#0D0F16]/95 border-b border-[#1A1F2C] backdrop-blur-md sticky top-0 z-30 px-4 sm:px-6 flex items-center justify-between gap-4 font-sans">
        ...
        {/* Right: Mode Switcher, Notifications, Agent Status & Profile Dropdown */}
          ...
          {user && (
            <div className="relative">
              ...
              >
                ...
                <span className="text-xs font-sans text-slate-200 font-medium truncate max-w-[100px] hidden sm:inline">
              ...
              {isUserMenuOpen && (
                <div className="absolute right-0 mt-2 w-52 bg-[#0D0F16] border border-[#1A1F2C] rounded-2xl shadow-2xl p-1.5 space-y-1 z-50 animate-fade-in text-xs">
                  <div className="px-3 py-2 border-b border-[#1A1F2C]">
                    <div className="font-bold text-white truncate">{user.name || "Analyst User"}</div>
